    ...
    return (
        <div className="p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-black text-[#0a1628]">{t('employee.universities.title')}</h1>
                    <p className="text-sm text-gray-400 mt-1">{t('employee.universities.desc')}</p>
                </div>
                                    ...
                                    <tr key={item.id} className="border-b border-gray-50 hover:bg-[#f4f6fb] transition-colors">
                                        ...
                                        <td className="px-5 py-3.5">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 rounded-lg bg-[#c8a44e]/10 text-[#c8a44e] flex items-center justify-center"><Building2 className="w-4 h-4" /></div>
