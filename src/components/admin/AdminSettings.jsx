...
const AdminSettings = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* التبويبات الداخلية */}
      <div className="flex gap-2 mb-8 bg-white dark:bg-[#211c18] p-1.5 rounded-xl border border-gray-200 dark:border-[#3a322c]/60 w-fit shadow-sm">
        {[
      ...
      {activeTab === 'hero' && (
        <div className="bg-white dark:bg-[#211c18] rounded-2xl shadow-sm border border-gray-200 dark:border-[#3a322c]/60 p-6 md:p-8 space-y-6">
