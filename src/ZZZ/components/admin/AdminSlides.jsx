...
const AdminSlides = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {actionError && (
        <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/15 text-red-600 dark:text-red-400 rounded-xl flex items-center gap-3 text-sm font-medium border border-red-100 dark:border-red-800/30">
            ...
            <div key={slide.id} className="bg-white dark:bg-brand-dark-card rounded-2xl shadow-sm border border-gray-200 dark:border-brand-dark-border/60 overflow-hidden group relative">
              ...
              <div className="p-4 flex items-center justify-between border-t border-gray-100 dark:border-brand-dark-border">
                ...
                <button 
                  ...
                  className="p-2 text-red-500 bg-red-50 dark:bg-red-900/15 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/25 transition-colors"
