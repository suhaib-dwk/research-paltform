...
export const MINISTRY_SPACES = [
  {
    ...
    items_ar: ["الباحثون والمنشورات والمشاريع والتمويل والتعاون والابتكار والبنية التحتية والقدرات والأثر", "تمييز صريح بين البيانات الخام والمتحقق منها والموحّدة والمؤشرات المشتقة ورؤى السياسة", "تنبيهات: فجوة حرجة، مجال صاعد، أولوية ناقصة التمويل، فرصة شراكة، نقص قدرات"],
    items_en: ["Researchers, publications, projects, funding, collaboration, innovation, infrastructure, capacity and impact", "Explicit separation of raw, verified, normalised data, derived indicators and policy insights", "Alerts: critical gap, emerging field, underfunded priority, collaboration opportunity, capacity shortage"],
  },
  {
    number: "02", mock: "priorities",
    ...
    desc_ar: "الجسر العكسي بين الدولة والجامعات: من احتياجات الدولة إلى تحديات القطاعات إلى أولويات وموضوعات، ثم قياس تغطيتها بحثيًا وتحويل الفجوات إلى دعوات وتمويل وشراكات. القطاعات قابلة للتهيئة — لا أسماء ثابتة في الكود.",
    desc_en: "The reverse bridge from the state to universities: from national needs to sector challenges to priorities and topics, then measuring their research coverage and turning gaps into calls, funding and partnerships. Sectors are configurable — never hard-coded.",
    items_ar: ["مؤشر أولوية بصيغة وأوزان معتمدة (الحاجة، الفجوة، مواءمة السياسة، القدرة، الاتجاه)", "تغطية الأولوية = النشاط البحثي الفعلي مقابل المستهدف، على مستوى الجامعات والجغرافيا", "دورة اعتماد: مسودة → أدلة → مراجعة قطاعية → مراجعة خبراء → اعتماد الوزارة → نشر"],
    items_en: ["A priority index with an approved formula and weights (need, gap, policy alignment, capacity, trend)", "Priority coverage = actual research activity vs target, by university and geography", "Approval cycle: draft → evidence → sector review → expert review → Ministry approval → published"],
  },
  {
    number: "03", mock: "network",
    title_ar: "الشراكات والاتفاقيات البحثية", title_en: "Research partnerships & agreements",
    question_ar: "مع من يجب أن نتعاون داخليًا وإقليميًا وعالميًا؟", question_en: "Who should we collaborate with nationally, regionally and globally?",
    desc_ar: "محرك ذكاء للشراكات لا قاعدة اتفاقيات فقط: من يتعاون مع من، في ماذا، بأي نتائج، وأين توجد فرصة شراكة تعالج فجوة وطنية — بين الجامعات، ومع المراكز والصناعة والبلديات، ومع الشركاء العرب والدوليين.",
    desc_en: "A partnership intelligence engine, not just an agreements database: who collaborates with whom, on what, with which results, and where a partnership could close a national gap — between universities, with centres, industry and municipalities, and with Arab and international partners.",
    items_ar: ["مطابقة بأبعاد معلنة: تقارب الموضوع، الخبرة المكمّلة، البنية التحتية، ملاءمة التمويل، خدمة الأولوية، الأثر، الجغرافيا", "كل مطابقة تشرح سبب الاقتراح، ثم مراجعة بشرية وتواصل", "إدارة الاتفاقيات بالتزاماتها ومخرجاتها ومؤشراتها وتنبيه قبل الانتهاء"],
    items_en: ["Matching on declared dimensions: topic similarity, complementary expertise, infrastructure, funding fit, priority fit, impact, geography", "Every match explains why it was proposed, followed by human review and outreach", "Agreements managed with commitments, outputs, KPIs and renewal alerts"],
  },
  {
    number: "04", mock: "funding",
    ...
    items_ar: ["مطابقة ملف الباحث أو الفريق والموضوع والسجل والأهلية والميزانية مع الفرص", "درجة الملاءمة ترتيب داخلي — وليست قرار قبول من الجهة الممولة", "تنبيهات المواعيد وسير عمل التقديم من داخل المنصة"],
    items_en: ["Matching the researcher or team profile, topic, track record, eligibility and budget to opportunities", "The fit score is an internal ranking — never an acceptance decision by the funder", "Deadline alerts and an application workflow inside the platform"],
  },
];
