            ...
            <div className="container mx-auto px-6">
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                {detail.explanation.map((e, i) => (
                  <article key={e.title_en} className="bg-white border border-gray-200 p-7 md:p-8 flex flex-col gap-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {detail.indicators.map((ind) => (
              <button
                ...
                className="group text-start bg-white border border-gray-200 hover:border-brand-orange/50 hover:shadow-lg transition-all duration-300 p-7 flex flex-col gap-3"
              >
                <div className="flex items-center justify-between gap-3">
                  <span dir="ltr" className="text-[11px] font-extrabold tracking-[0.15em] text-brand-orange">{ind.code}</span>
                  {ind.current && !ind.current.value && (
                    <span className="text-[10px] font-bold text-brand-muted border border-gray-200 px-2 py-0.5">{labels.pendingData}</span>
                  )}
                </div>
