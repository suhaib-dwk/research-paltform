...
export const SERVICES_CATALOGUE = [
  ...
  {
    id: "P06", family: "journal", exec: "ai",
    name_ar: "اختيار المجلة الأنسب للنشر", name_en: "Selecting the Best-Fit Journal",
    desc_ar: "تحليل موضوع البحث ومجاله ومستواه وأهداف النشر، واقتراح المجلات الأكثر ملاءمة للتقديم.",
  ...
  },
  {
    ...
    name_ar: "تقييم جاهزية البحث للمجلة", name_en: "Journal Readiness Assessment",
    desc_ar: "مراجعة مدى توافق البحث مع نطاق المجلة ومتطلباتها، وتحديد نقاط التحسين المطلوبة قبل التقديم.",
  ...
  },
  {
    ...
    name_ar: "إعداد البحث وفق متطلبات المجلة", name_en: "Preparing the Research for Journal Requirements",
    desc_ar: "مراجعة البحث وتجهيزه وفق تعليمات المجلة المستهدفة، بما يشمل تنظيم المحتوى والجداول والأشكال والمراجع ومتطلبات التقديم.",
  ...
  },
  {
    ...
    name_ar: "إعداد خطاب التقديم للمجلة", name_en: "Journal Submission Letter",
    desc_ar: "إعداد خطاب تقديم مهني يبرز قيمة البحث وملاءمته للمجلة، ومراجعته قبل الإرسال.",
