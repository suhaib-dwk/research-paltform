...
try {
    ...
    if ($mode === 'ministry_chatbot') {
        ...
        $pageFocus = [
            ...
            'partnerships'      => ['مساحة «الشراكات البحثية»: التعاون الدولي والشركاء؛ الشراكات تنشأ محليًا (طلبة، باحثون، جامعات، مراكز) وتصل الوزارة كبيانات — الوزارة لا تُنشئها.', 'the "Research partnerships" space: international collaboration and partners; partnerships start locally (students, researchers, universities, centres) and reach the Ministry as data — the Ministry does not create them.'],
            'funding'           => ['مساحة «فرص التمويل البحثي»: نسبة الأبحاث الممولة، الجهات الممولة، السيناريوهات، وفرص التمويل للطلبة والباحثين — أحِل للموقع الرسمي للمواعيد والشروط.', 'the "Research funding opportunities" space: funded-research rate, funders, scenarios, and opportunities for students and researchers — refer to official sites for deadlines and conditions.'],
        ];
